...
type
  TSass_File_Context = IntPtr {Pointer};
  TSass_Compiler =  IntPtr {Pointer};
  TSass_Context = IntPtr {Pointer};
  TSass_included_files = IntPtr {Pointer};
  TSass_Data_Context = IntPtr {Pointer};
